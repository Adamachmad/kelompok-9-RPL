...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $stmt = $link->prepare("INSERT INTO listrik_air (Id_listrik, Nama, No_Kamar, Tunggakan, Total_bayar  ) 
                          VALUES (?, ?, ?, ?, ?)");
    $stmt->bind_param("sssss", $Id_listrik, $No_Kamar, $Nama, $Tunggakan, $Total_bayar );
        ...
        <div class="content">
            <div class="card mb-4">
                ...
                <div class="card-body">
                    <form method="post">
                        <div class="mb-3">
                            <label for="Id_listrik" class="form-label">ID Listrik</label>
                            <input type="int" class="form-control" id="Id_listrik" name="Id_listrik" required>
                        </div>
                        <div class="mb-3">
