            ...
            <div class="search-add-bar mb-4">
                <form action="" method="GET">
                    <div class="input-group">
                        ...
                        <a href="tambah_wifi.php" class="btn btn-success ms-3">Tambah Data</a>
                    </div>
                </form>
            </div>
            <div class="card mb-4">
                <div class="card-header">
                    <h3>Ini adalah Data123</h3>
                </div>
                <div class="card-body">
                        ...
                        if ($result->num_rows > 0) {
                            ...
                            while($row = $result->fetch_assoc()) {
                                echo "<tr>
                                        ...
                                        <td>
                                            <a href='edit_wifi.php?Pass_wifi=" . $row['Pass_wifi'] . "' class='btn btn-warning btn-sm me-1'><i class='fas fa-edit'></i> Edit</a>
                                            <a href='hapus_wifi.php?Pass_wifi=" . $row['Pass_wifi'] . "' class='btn btn-danger btn-sm' onclick='return confirm(\"Apakah Anda yakin ingin data ini?\")'><i class='fas fa-trash'></i> Delete</a>
                                        </td>
                                    </tr>";
                            }
                        } else {
